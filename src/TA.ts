...
const megaTable: [[string, string], string][] = [
  ...
  // Z-A
  [['barbaracle',       'barbaracite'],   'toughclaws'],
  ...
  [['malamar',          'malamarite'],    'contrary'],
  [['meganium',         'meganiumite'],   'megasol'],
  [['pyroar',           'pyroarite'],     'firemane'],
  [['scolipede',        'scolipite'],     'shellarmor'],
  [['scrafty',          'scraftinite'],   'intimidate'],
  ...
  [['raichu',           'raichunitex'],   'electricsurge'],
  [['raichu',           'raichunitey'],   'noguard'],
  [['scovillain',       'scovillainite'], 'spicyspray'],
  [['staraptor',        'staraptite'],    'contrary'],
